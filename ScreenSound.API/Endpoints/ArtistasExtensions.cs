...
public static class ArtistasExtensions
{
    public static void AddEndPointsArtistas(this WebApplication app)
    {
        ...
        var pessoa = dalPessoa.RecuperarPor(p => p.Email?.Equals(email) == true)
    ?? throw new InvalidOperationException("Pessoa não está conectada");
    ...
    private static AvaliacaoArtistaResponse AvaliacaoArtistaResponse(AvaliacaoArtista avaliacao)
    {
        return new AvaliacaoArtistaResponse(avaliacao.ArtistaId, avaliacao.Nota);
    }
